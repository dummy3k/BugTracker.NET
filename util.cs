...
namespace btnet
{
	...
	public class Security {
		...
		public void check_security(DbUtil dbutil, HttpContext asp_net_context, int level)
		{
            ...
            this_external_user = Convert.ToBoolean(dr["us_external_user"]);
            this_can_edit_sql = Convert.ToBoolean(dr["us_can_edit_sql"]);
            this_can_delete_bug = Convert.ToBoolean(dr["us_can_delete_bug"]);
            this_can_edit_and_delete_posts = Convert.ToBoolean(dr["us_can_edit_and_delete_posts"]);
            this_can_merge_bugs = Convert.ToBoolean(dr["us_can_merge_bugs"]);
            this_can_mass_edit_bugs = Convert.ToBoolean(dr["us_can_mass_edit_bugs"]);
            this_can_use_reports = Convert.ToBoolean(dr["us_can_use_reports"]);
            this_can_edit_reports = Convert.ToBoolean(dr["us_can_edit_reports"]);
            this_can_be_assigned_to = Convert.ToBoolean(dr["us_can_be_assigned_to"]);
